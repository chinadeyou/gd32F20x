...
/* I2C2 GPIO PORT GPIOA GPIOC, GPIOA8, GPIOC9 */
#define RCU_I2C_SCL_PORT	RCU_GPIOA
#define RCU_I2C_SDA_PORT	RCU_GPIOC
#define I2C2_SCL_PORT		GPIOA
#define I2C2_SDA_PORT		GPIOC
#define I2C2_SCL_PIN		GPIO_PIN_8
#define I2C2_SDA_PIN 		GPIO_PIN_9

#define I2C2_SCL_SET()     gpio_bit_set			(I2C2_SCL_PORT, I2C2_SCL_PIN)
#define I2C2_SCL_RESET()   gpio_bit_reset		(I2C2_SCL_PORT, I2C2_SCL_PIN)
#define I2C2_SDA_SET()     gpio_bit_set			(I2C2_SDA_PORT, I2C2_SDA_PIN)
#define I2C2_SDA_RESET()   gpio_bit_reset		(I2C2_SDA_PORT, I2C2_SDA_PIN)
#define READ_I2C2_SDA()    gpio_input_bit_get	(I2C2_SDA_PORT, I2C2_SDA_PIN)

#define I2C2_SDA_OUT()     gpio_init(I2C2_SDA_PORT, GPIO_MODE_OUT_PP, GPIO_OSPEED_50MHZ, I2C2_SDA_PIN)
#define I2C2_SDA_IN()      gpio_init(I2C2_SDA_PORT, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_50MHZ, I2C2_SDA_PIN)
...
void i2c2_init(void)
{
    /* enable I2C GPIO Port clock */
    rcu_periph_clock_enable(RCU_I2C_SCL_PORT);
    rcu_periph_clock_enable(RCU_I2C_SDA_PORT);
...
{
    I2C2_SDA_OUT();     //设置SDA为输出
    I2C2_SDA_SET();
    I2C2_SCL_SET();
    delay_1us(BASIC_DELAY_US);
    
 	I2C2_SDA_RESET();	//发送Start信号
    delay_1us(BASIC_DELAY_US);
    
    I2C2_SCL_RESET();	//设置SCL为低电平,准备发送或接收数据
} /* i2c2_start() */
...
void i2c2_ack(void)
{
    I2C2_SCL_RESET();
    I2C2_SDA_OUT();
    I2C2_SDA_RESET();		//主机拉低SDA,发送Ack信号
    delay_1us(BASIC_DELAY_US);
...
{
    i2c2_start();
    i2c2_send_byte(slave_addr);		//发送从机地址 + Write
    i2c2_wait_ack();
...
{		  	    																 
    ...
    i2c2_wait_ack();
    i2c2_start();
    i2c2_send_byte(slave_addr+1);	//发送从机地址 + Read
    i2c2_wait_ack();
